class HomeController < ApplicationController
  # before_action :authenticate_user!, except: [:upload_books_csv, :add_books_date]

  # http://localhost:3000/home/1/upload_books_csv
  ...
  def add_books_data
    if params[:books_data][:uploaded_file].present?
      ...
      redirect_to upload_books_csv_home_path(id: 1), success: "Books data added successfully"
    end
  end
end
